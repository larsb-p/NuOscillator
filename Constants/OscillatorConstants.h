...
inline std::vector<FLOAT_T> ReturnOscParams_Beam_wYe_wDeco() {
  std::vector<FLOAT_T> OscParams_Beam_wYe_wDeco = { 3.07e-1, 5.61e-1, 2.220e-2, 7.53e-5, 2.494e-3, -1.601, 295.0, 2.6, 0.5, 5.0e-15, -2.0, 1.0}; // T2K Set A
  //std::vector<FLOAT_T> OscParams_Beam_wYe_wDeco = { 3.07e-1, 4.50e-1, 2.220e-2, 7.53e-5, 2.494e-3, 0.0, 295.0, 2.6, 0.5, 5.0e-15, -2.0, 1.0}; // T2K Set B
